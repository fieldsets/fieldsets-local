/**
 * setup_record_store: Takes a fieldset token and associated ids and creates partitions for the given STORE_TYPE.
 * @param FIELDSET_RECORD: fs_record
 * @param FIELDSET_RECORDS[]: fs_child_records
 **/
CREATE OR REPLACE PROCEDURE fieldsets.setup_record_store(fs_record FIELDSET_RECORD, fs_child_records FIELDSET_RECORD[]) AS $procedure$
DECLARE
    store_token TEXT;
    store_tbl_name TEXT;
...
COMMENT ON PROCEDURE fieldsets.setup_record_store(FIELDSET_RECORD,FIELDSET_RECORD[]) IS
'/**
 * setup_record_store: Takes a fieldset token and associated ids and creates partitions for the given STORE_TYPE.
 * @param FIELDSET_RECORD: fs_record
 * @param FIELDSET_RECORDS[]: fs_child_records
