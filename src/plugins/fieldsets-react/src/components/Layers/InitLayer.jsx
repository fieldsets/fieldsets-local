...
const Defaults = React.lazy(() => import('../Hooks/Handlers/Defaults'));
const Status = React.lazy(() => import('../Hooks/Handlers/Status'));
const Portals = React.lazy(() => import('../Hooks/Handlers/Portals'));
