import { Fetch, Update, Defaults } from '../calls';
...
export const Initialize = ( call ) => {
  ...
  switch (call.target) {
    ...
    case 'Controller':
    case 'controller':
      initializeSetData( { data: [], defaults: {...defaults} } );
      initializeFieldData( { data: [], defaults: {...defaults} } );
      initializeMetaData( { data: [], defaults: {...defaults} } );
