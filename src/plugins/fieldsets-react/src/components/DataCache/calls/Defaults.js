...
export const Defaults = ( call, data ) => {
  if ( data ) {
    ...
    if (key && type) {
      ...
      let metadata = { ...defaults.fragments.meta[metatype] };
      const metafields = { ...defaults.fragments.meta[metatype] };
      ...
      previous = (previous) ? { ...previous } : { ...defaults.fragments[type] };
