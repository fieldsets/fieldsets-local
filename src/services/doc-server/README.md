...
# Running Community Docs Locally
- `git clone http://github.com/nstankov-bg/docs.plutus-community.com`
- `cd docs.plutus-community.com/docker`
- `docker-compose up -d`
- You can now access local documentation at http://localhost:4001/
