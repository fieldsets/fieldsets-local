[![banner](https://raw.githubusercontent.com/opennormalform/art/master/github/repo-banner%402x.png)](https://docs.opennormalform.org)

<h1 align="center">docs</h1>

> 🐬 Open Normal Form documentation. https://docs.opennormalform.org

[![Build Status](https://github.com/opennormalform/docs/workflows/CI/badge.svg)](https://github.com/opennormalform/docs/actions)
[![Netlify Status](https://api.netlify.com/api/v1/badges/218e617e-45da-47ab-8f2a-bcfedf80550f/deploy-status)](https://app.netlify.com/sites/docs-opennormalform/deploys)
[![Maintainability](https://api.codeclimate.com/v1/badges/d39837421591f0bc2550/maintainability)](https://codeclimate.com/github/opennormalform/docs/maintainability)
[![js opennormalform](https://img.shields.io/badge/js-opennormalform-7b1173.svg)](https://github.com/opennormalform/eslint-config-opennormalform)
[![css bigchaindb](https://img.shields.io/badge/css-bigchaindb-39BA91.svg)](https://github.com/bigchaindb/stylelint-config-bigchaindb)

---

**These docs are meant to be viewed on [docs.opennormalform.org](https://docs.opennormalform.org). You can still browse them here but links or images might not work in some places.**
...
```bash
git clone git@github.com:opennormalform/website.git
cd website/
...
- ESLint with [eslint-config-opennormalform](https://github.com/opennormalform/eslint-config-opennormalform)
...
The latest deployment of the `main` branch is automatically aliased to `docs.opennormalform.org`.

## License

```text
Copyright ((C)) 2022 Open Normal Form.
