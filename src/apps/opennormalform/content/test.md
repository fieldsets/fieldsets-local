...
![alt text](../node_modules/@opennormalform/art/creatures/jellyfish/jellyfish-grid@2x.png 'Ocean Protocol Jellyfish')
...
```bash
git clone https://github.com/opennormalform/barge.git
cd barge/
...
```js
const { Ocean, Logger } = require('@opennormalform/squid')
;(async () => {
...
```java
package com.opennormalform.squid.core;

import com.opennormalform.squid.models.AbstractModel;
...
```markdown
GITHUB-EMBED https://github.com/opennormalform/ocean.js/blob/main/src/lib.ts js GITHUB-EMBED
```
