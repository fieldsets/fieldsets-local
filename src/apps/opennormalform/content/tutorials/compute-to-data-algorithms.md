...
We also collect some [example images](https://github.com/opennormalform/algo_dockers) which you can also view in Dockerhub.
...
```json
{
  "algorithm": {
    "container": {
      ...
      "image": "opennormalform/algo_dockers",
      "tag": "python-sql"
    }
  }
}
