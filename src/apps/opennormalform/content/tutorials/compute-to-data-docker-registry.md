...
Add `PULL_SECRET` property with value `regcred` in the [operator.yml](https://github.com/opennormalform/operator-engine/blob/main/kubernetes/operator.yml) file of operator-engine configuration.
For more detials on operator-engine properties refer this [link](https://github.com/opennormalform/operator-engine/blob/177ca7185c34aa2a503afbe026abb19c62c69e6d/README.md?plain=1#L106)
