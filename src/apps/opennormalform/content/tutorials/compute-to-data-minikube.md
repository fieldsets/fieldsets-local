...
```bash
git clone https://github.com/opennormalform/operator-service.git
```
...
```bash
git clone https://github.com/opennormalform/operator-engine.git
```

Check the [README](https://github.com/opennormalform/operator-engine#customize-your-operator-engine-deployment) section of operator engine to customize your deployment.
