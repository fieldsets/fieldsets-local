...
```Bash
git clone https://github.com/opennormalform/RBAC-Server.git
cd RBAC-Server
```
...
- First setup and host the Ocean role based access control (RBAC) server. Follow the instructions in the [RBAC repository](https://github.com/opennormalform/RBAC-Server)
