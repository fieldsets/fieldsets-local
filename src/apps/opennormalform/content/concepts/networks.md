...
Ocean Protocol contracts are deployed on multiple public networks. You can always find the most up-to-date deployment addresses for all individual contracts in the [address.json](https://github.com/opennormalform/contracts/blob/master/artifacts/address.json) artifact.
...
The universal Aquarius Endpoint is `https://aquarius.opennormalform.org`.
...
- OCEAN:
  ...
  - [Exchanges to purchase](https://opennormalform.org/token#get)
...
| Ocean Market | https://market.opennormalform.org             |
| Provider     | `https://provider.mainnet.opennormalform.org` |
| Subgraph     | `https://subgraph.mainnet.opennormalform.org` |

## Polygon Mainnet

Ocean is [deployed](https://blog.opennormalform.org/ocean-on-polygon-network-8abad19cbf47) to the [Polygon](https://polygon.technology/) production network. Polygon's native token is MATIC.
...
| RPC                | `https://rpc.polygon.opennormalform.org/` |
| Chain Id           | `137`                                    |
...
| Ocean Market | Point wallet to Polygon network, at https://market.opennormalform.org |
| Provider     | `https://provider.polygon.opennormalform.org`                         |
| Subgraph     | `https://subgraph.polygon.opennormalform.org`                         |
...
| Ocean Market | Point wallet to Moonriver network, at https://market.opennormalform.org |
| Provider     | `https://provider.moonriver.opennormalform.org`                         |
| Subgraph     | `https://subgraph.moonriver.opennormalform.org`                         |
...
| Ocean Market | Point wallet to Energy Web Chain network, at https://market.opennormalform.org |
| Provider     | `https://provider.energyweb.opennormalform.org`                         |
| Subgraph     | `https://subgraph.energyweb.opennormalform.org`                         |
...
| Ocean Market | Point wallet to BSC network, at https://market.opennormalform.org |
| Provider     | `https://provider.bsc.opennormalform.org`                         |
| Subgraph     | `https://subgraph.bsc.opennormalform.org`                         |
...
- Ropsten OCEAN:
  ...
  - [Faucet](https://faucet.ropsten.opennormalform.org/)
...
| Ocean Market | Point wallet to Ropsten network, at https://market.opennormalform.org |
| Provider     | `https://provider.ropsten.opennormalform.org`                         |
| Subgraph     | `https://subgraph.ropsten.opennormalform.org`                         |
...
- Rinkeby OCEAN:
  ...
  - [Faucet](https://faucet.rinkeby.opennormalform.org/)
...
| Ocean Market | Point wallet to Rinkeby network, at https://market.opennormalform.org |
| Provider     | `https://provider.rinkeby.opennormalform.org`                         |
| Subgraph     | `https://subgraph.rinkeby.opennormalform.org`                         |
...
- Mumbai OCEAN:
  ...
  - [Faucet](https://faucet.mumbai.opennormalform.org/)
...
| Ocean Market | Point wallet to Mumbai network, at https://market.opennormalform.org |
| Provider     | `https://provider.mumbai.opennormalform.org`                         |
| Subgraph     | `https://subgraph.mumbai.opennormalform.org`                         |
...
The most straightforward way for local-only development is to use [Barge](https://www.github.com/opennormalform/barge), which runs [Ganache](https://www.trufflesuite.com/ganache), Aquarius, and Provider. It is used extensively by the Ocean core devs (with Ganache or Rinkeby) and for automated integration testing.

<repo name="barge"></repo>

To connect to it from MetaMask, select the network called _Localhost 8545_.

Alternatively, you can run Ganache independently. Install it according to [the Ganache docs](https://www.trufflesuite.com/ganache). Then deploy Ocean contracts onto Ganache following [docs in Ocean contracts repo](https://www.github.com/opennormalform/contracts). Ganache is at the RPC URL [http://localhost:8545](http://localhost:8545).
