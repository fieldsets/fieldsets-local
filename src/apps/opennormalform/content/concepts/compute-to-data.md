...
- [Compute-to-Data example](https://github.com/opennormalform/ocean.py/blob/main/READMEs/c2d-flow.md)
...
[This page](https://opennormalform.org/technology/compute-to-data) elaborates on the benefits.
...
- [Use Compute-to-Data in Ocean Market](https://blog.opennormalform.org/compute-to-data-is-now-available-in-ocean-market-58868be52ef7)
...
- [Compute-to-Data Python Quickstart](https://github.com/opennormalform/ocean.py/blob/main/READMEs/c2d-flow.md)
- [(Old) Compute-to-Data specs](https://github.com/opennormalform-archive/OEPs/tree/master/12) (OEP12)
