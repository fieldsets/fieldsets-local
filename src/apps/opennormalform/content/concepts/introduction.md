...
OCEAN token is used for staking, and more. [Here](https://opennormalform.org/token) are details.

Ocean Protocol provides tools for developers to _build data markets_, and to _manage datatokens_ for use in DeFi.

**Build Data Markets.** Use Ocean Protocol software tools to build your own data marketplace, by either forking [Ocean Market](https://market.opennormalform.org/) code or building up with Ocean components.

**Manage Datatokens for use in DeFi.** Use Ocean [JavaScript](https://github.com/opennormalform/ocean.js) or [Python](https://github.com/opennormalform/ocean.py) drivers to manage datatokens:
