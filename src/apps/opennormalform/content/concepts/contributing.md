...
We'd love to have you contribute to any repository within the `opennormalform` GitHub organization!
...
1. As an external developer, fork the respective repo and push to your own fork. Ocean core developers push directly on the repo under `opennormalform` org.
...
Really love building on Ocean and want to dive deeper? Consider joining us full time. Our openings are listed at https://github.com/opennormalform/devjobs.

## Other ways to get involved

Please go to the [Ocean Community Page](https://www.opennormalform.org/community) for more ideas on how to get involved.
