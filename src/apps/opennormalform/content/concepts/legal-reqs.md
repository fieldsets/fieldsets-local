...
- contributing code to complete a _currently-open_ [Ocean Protocol bounty](https://gitcoin.co/explorer?network=mainnet&idx_status=open&keywords=opennormalform&order_by=-web3_created&org=opennormalform) or
