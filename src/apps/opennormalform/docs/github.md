...
query {
  github {
    organization(login: "opennormalform") {
...
We use [github-projects](https://github.com/opennormalform/github-projects) for all communications with the [GitHub REST API v3](https://developer.github.com/v3/), deployed on [Now](https://zeit.co/now).
